...
<button type="button" class="btn btn-success"  style="float: left;" onclick="window.location.href='./maingallery.php?source=edit'">Add new Post</button>
<button type="button" class="btn btn-warning"  style="float: right;" onclick="window.location.href='pdfgenerate/posts.php'">Generate a report</button><br><br>
