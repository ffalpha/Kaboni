    ...
    <div class="container-fluid">
        ...
        <div class="content">
                           ...
                           <div class="row">
                                    ...
                                    <center><button type="submit" class="btn btn-info btn-fill pull-right" name="add">Place the order</button></center>
...
if(isset($_POST['add'])){
    ...
    $id=$_POST['pack'];
     ...
     $od=$_POST['content'];
     $query="INSERT INTO orders(cemail,package,date,status,description,fname,lname,tpnumber,address) values('$email','$id','$date','Waiting for conformation
','$od','$fname','$lname','$tpnumber','$address')";
    $result=mysqli_query($connect,$query);
